...
def remove_duplicates(apps, schema_editor):
    ...
    first_pks_by_day = System.objects.annotate(
    ...
    ).values("first_pk_by_day").distinct()
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL('SET CONSTRAINTS ALL IMMEDIATE', reverse_sql=migrations.RunSQL.noop),  # Flush pending tirggers
        migrations.AddConstraint(
            model_name='system',
            constraint=models.UniqueConstraint(django.db.models.expressions.F('system_id'), django.db.models.functions.datetime.TruncDay('created'), name='unique_system_checkin_per_day'),
        ),
    ]
